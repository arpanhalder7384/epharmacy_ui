...
const AllopathyPage = () => {
  ...
  const [allopathyMedicines, setAllopathyMedicines] = useState([])
  ...
  useEffect(() => {
    dispatch(showLoader());
    fetchMedicines(currentPage + 1, ITEMS_PER_PAGE, "Allopathy", sortType, sortOrder) // Page 1, Size 10, Sort by Name (A-Z)
      .then((res) => {
        console.log(res.data.medicines)
        setPageCount(res.data.total / ITEMS_PER_PAGE)
        setAllopathyMedicines(res.data.medicines);
      })
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {allopathyMedicines.map((medicine) => (
