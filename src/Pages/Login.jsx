  ...
  const handleLogin= ()=>{
    ...
    loginUser(loginData).then((res) => {
      ...
      const userData = {
        ...
        "customerEmailId": customerdata.customerEmailId,
      ...
      fetchCart(customerdata.customerId).then((res) => {
        if (res.data?.items) {
          dispatch(updateItemCount(res.data.items.length))
        }
      }).catch((e) => {
          ...
          <div className='flex mt-10  '>
            <form className="w-full">
              <div className="mb-5w-full">
                ...
                {(emailIdErr !== "" && emailId!=="") && <label className='text-red-800'>{emailIdErr}</label>}
              </div>
              <div className="w-full">
                ...
                {(passwordErr !== "" && password!=="") && <label className='text-red-800'>{passwordErr}</label>}
              ...
              <div className='flex flex-col justify-center w-full'>
                <button type="submit" disabled={!isValid} onClick={()=>handleLogin()}
