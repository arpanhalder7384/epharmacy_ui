      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <Card className="shadow-lg">
          <CardContent className="text-center">
            ...
            <Typography variant="body2" className="mb-4">
              Explore a wide range of medicines for various health needs, avaialble at the best price.
            </Typography>
            <Button
              variant="contained"
              color="primary"
        ...
        <Card className="shadow-lg">
          <CardContent className="text-center">
            ...
            <Typography variant="body2" className="mb-4">
              Shop for snikcare, faircare, and wellness essentials to keep you feeling your best.
            </Typography>
            <Button
              variant="contained"
              color="primary"
